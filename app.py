...
frame = ttk.Frame(root, padding="30 30 30 30", style='TFrame')
...
date_entry = DateEntry(frame, width=23, background='darkblue', foreground='white', borderwidth=2)
date_entry.grid(column=1, row=1, sticky=(tk.W, tk.E))

ttk.Label(frame, text="Amount:").grid(column=0, row=2, sticky=tk.W)

amount_entry = ttk.Entry(frame, validate='key', width=25)
